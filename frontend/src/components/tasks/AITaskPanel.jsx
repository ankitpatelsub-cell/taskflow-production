            ...
            {subtasks.map((st, i) => (
              <li key={i}>
                <button
                  ...
                  className={cn(
                    'w-full flex items-start gap-2.5 px-3 py-2 rounded-xl border text-left transition-colors',
                    checked[i]
    ...
    <div className="rounded-xl border border-indigo-100 dark:border-indigo-800 bg-gradient-to-br from-indigo-50/60 to-purple-50/40 dark:from-indigo-900/20 dark:to-purple-900/10 p-4 space-y-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={cn(
            'flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl border text-xs font-semibold transition-colors',
